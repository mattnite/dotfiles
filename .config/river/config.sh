...
riverctl map normal $mod Semicolon spawn bemenu-run -H 26
...
riverctl map normal $mod+Mod4 H move left 100
riverctl map normal $mod+Mod4 J move down 100
riverctl map normal $mod+Mod4 K move up 100
riverctl map normal $mod+Mod4 L move right 100

# Mod+Alt+Control+{H,J,K,L} to snap views to screen edges
riverctl map normal $mod+Mod4+Control H snap left
riverctl map normal $mod+Mod4+Control J snap down
riverctl map normal $mod+Mod4+Control K snap up
riverctl map normal $mod+Mod4+Control L snap right

# Mod+Alt+Shif+{H,J,K,L} to resize views
riverctl map normal $mod+Mod4+Shift H resize horizontal -100
riverctl map normal $mod+Mod4+Shift J resize vertical 100
riverctl map normal $mod+Mod4+Shift K resize vertical -100
riverctl map normal $mod+Mod4+Shift L resize horizontal 100
